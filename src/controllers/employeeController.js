...
const employeeSchema = z
  .object({
    ...
    pastServices: z.array(pastServiceSchema).optional().default([]),
    education: z.array(educationSchema).optional().default([]),
    postgraduateQualifications: z.array(postgradSchema).optional().default([]),
    timeboundPromotions: z.array(timeboundSchema).optional().default([]),
    administrativeRoles: z.array(adminRoleSchema).optional().default([]),
